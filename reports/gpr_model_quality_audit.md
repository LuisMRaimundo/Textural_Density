...
- Repository SHA: `ef5c17707c127beeab04753c717150a5f58b5734`
- Classification: **PASS**
- Instruments: 8
- Source rows: 357
- Convex-hull departures (pp–mf): **55**
- Convex-hull departures (pp–mf–ff): **33**
...
- **bassoon**: 42 rows, hull departures=8 (19.0%), max |GPR−linear|=3.071
- **cello**: 49 rows, hull departures=13 (26.5%), max |GPR−linear|=2.897
- **clarinet**: 47 rows, hull departures=3 (6.4%), max |GPR−linear|=1.410
- **double_bass**: 45 rows, hull departures=5 (11.1%), max |GPR−linear|=3.258
- **flute**: 40 rows, hull departures=2 (5.0%), max |GPR−linear|=0.924
- **oboe**: 36 rows, hull departures=6 (16.7%), max |GPR−linear|=1.093
- **viola**: 49 rows, hull departures=10 (20.4%), max |GPR−linear|=0.580
- **violin**: 49 rows, hull departures=8 (16.3%), max |GPR−linear|=1.205
...
- viola B6 (MIDI 95, high): pp=3.939 mp=4.149 mf=3.973 |Δlin|=0.184 |Δquad|=0.258 [REVIEW REQUIRED] mp outside pp–mf interval
- viola C7 (MIDI 96, high): pp=4.261 mp=3.993 mf=4.005 |Δlin|=0.077 |Δquad|=0.094 [REVIEW REQUIRED] mp outside pp–mf interval; mp near mf anchor
...
- clarinet F#6 (MIDI 90, high): pp=3.709 mp=3.696 mf=3.236 |Δlin|=0.342 |Δquad|=0.474 [REVIEW REQUIRED] mp near pp anchor; non-monotonic source anchors
...
- cello F#2 (MIDI 42, low): pp=36.935 mp=37.899 mf=40.087 |Δlin|=1.400 |Δquad|=0.059 [OK] within expected diagnostic envelope
- clarinet F3 (MIDI 53, low): pp=11.828 mp=29.230 mf=34.489 |Δlin|=0.406 |Δquad|=0.747 [OK] within expected diagnostic envelope
- bassoon A#1 (MIDI 34, low): pp=60.113 mp=75.327 mf=82.082 |Δlin|=1.262 |Δquad|=0.217 [OK] within expected diagnostic envelope
...
- double_bass F#4 (MIDI 66, high): pp=22.610 mp=22.666 mf=23.292 |Δlin|=0.455 |Δquad|=0.086 [REVIEW REQUIRED] mp near pp anchor
...
- clarinet F#6 (MIDI 90, high): pp=3.709 mp=3.696 mf=3.236 |Δlin|=0.342 |Δquad|=0.474 [REVIEW REQUIRED] mp near pp anchor; non-monotonic source anchors
- clarinet A6 (MIDI 93, high): pp=4.916 mp=4.873 mf=4.438 |Δlin|=0.316 |Δquad|=0.440 [REVIEW REQUIRED] mp near pp anchor; non-monotonic source anchors
...
- violin A6 (MIDI 93, high): pp=7.428 mp=7.856 mf=7.846 |Δlin|=0.115 |Δquad|=0.233 [REVIEW REQUIRED] mp outside pp–mf interval; mp near mf anchor
- violin B6 (MIDI 95, high): pp=6.432 mp=6.902 mf=6.888 |Δlin|=0.128 |Δquad|=0.189 [REVIEW REQUIRED] mp outside pp–mf interval; mp near mf anchor
- violin F#7 (MIDI 102, high): pp=6.234 mp=6.149 mf=6.107 |Δlin|=0.011 |Δquad|=0.024 [REVIEW REQUIRED] mp near mf anchor; non-monotonic source anchors
...
- double_bass D#4 (MIDI 63, high): pp=23.600 mp=20.361 mf=20.314 |Δlin|=0.775 |Δquad|=0.203 [REVIEW REQUIRED] mp near mf anchor; non-monotonic source anchors
...
- bassoon D#5 (MIDI 75, high): pp=5.176 mp=5.725 mf=5.766 |Δlin|=0.107 |Δquad|=0.162 [REVIEW REQUIRED] mp near mf anchor
...
- Mean |GPR−linear|: 0.3214; mean |GPR−quadratic|: 0.1859.
- Mean |GPR−PCHIP|: 0.3053.
