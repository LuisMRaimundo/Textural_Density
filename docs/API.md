...
resultados["composite_meta"]      # mode, normalization_ref (REF), weight_factor, formula, use_log_compression, d_blend, blend_term_contributions (instrument_term, interval_term, instrument_to_interval_ratio — JSON null when the interval term is 0)
