...
| Instrument metadata | **Incomplete** — coarse fallbacks common; committed ladders migrating (violin arco full; others sparse); gradual curation |
...
- [ ] Commit full dynamic ladders for remaining table-backed instruments
