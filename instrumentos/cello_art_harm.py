# instrumentos/cello_art_harm.py
"""Cello artificial harmonics — registry/modal placeholder; no acoustic calibration."""
...
INSTRUMENT_SOURCE = InstrumentSource(
    ...
    citation=(
        "No same-instrument cello artificial_harmonic EWSD table in "
        "Strings_techniques_extrapolation measured calibration yet."
    ),
    source_url_or_identifier="docs/instrument_acoustic_sources.md#cello-art-harm",
