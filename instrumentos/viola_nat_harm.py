# instrumentos/viola_nat_harm.py
"""Viola natural harmonics — registry/modal placeholder; no acoustic calibration."""
...
INSTRUMENT_SOURCE = InstrumentSource(
    ...
    citation=(
        "No same-instrument viola natural_harmonic EWSD table in "
        "Strings_techniques_extrapolation measured calibration yet."
    ),
    source_url_or_identifier="docs/instrument_acoustic_sources.md#viola-nat-harm",
