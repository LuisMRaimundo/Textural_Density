...
INSTRUMENT_CONFIGS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "sounding": (50, 88),
        "comfortable": (55, 80),
        "registry_aliases": ("clarinet",),
        "extra_aliases": ("clarinete",),
        "zenodo_key": "clarinet",
        "zenodo_filename": "clarinet_sustains_median_summary_v1.xlsx",
        "source_workbook": "Clarinet.xlsx",
        "readme_title": "Clarinet median summary for Zenodo",
        "citation_technique": "sustained-note",
        "technique_label": "sustain",
    },
    {
