#!/usr/bin/env python3
"""Generate cello technique instrument modules from Desktop Excel workbooks.

Sources (assumption-based EWSD extrapolations from Strings_techniques_extrapolation):
  - c:\\Users\\lmr20\\Desktop\\Cello_pp.xlsx
  - c:\\Users\\lmr20\\Desktop\\Cello_mf.xlsx
  - c:\\Users\\lmr20\\Desktop\\Cello_ff.xlsx

Numeric techniques written:
  - con_sordino    → instrumentos/cello_sordina.py
  - sul_tasto      → instrumentos/cello_sul_tasto.py
  - sul_ponticello → instrumentos/cello_sul_ponticello.py

Harmonics are skipped: artificial/natural harmonic cells are unavailable
(no_harmonic_acoustic_calibration_data). No cello_art_harm module is created.
...
SRC_PP = Path(r"c:\Users\lmr20\Desktop\Cello_pp.xlsx")
SRC_MF = Path(r"c:\Users\lmr20\Desktop\Cello_mf.xlsx")
SRC_FF = Path(r"c:\Users\lmr20\Desktop\Cello_ff.xlsx")
...
TECHNIQUE_SPECS = {
    ...
    "sul_tasto": {
        ...
        "logger": "cello_sul_tasto",
        "doc_anchor": "cello-sul-tasto",
        "pitch_range": (36, 84),
        "comfortable": (40, 65),
        "brightness": "dark",
        "attack": "soft",
...
"""
Cello ({technique_label}) instrument density module.
...
INSTRUMENT_SOURCE = InstrumentSource(
    ...
    citation=(
        "Cello {technique} EWSD table from Strings_techniques_extrapolation "
...
'''
    ...
    print("registry: inserted cello technique profiles")
...
def main() -> int:
    ...
    print(
        ...
        "(unavailable in source workbooks). No cello_art_harm module created."
    )
    return 0
